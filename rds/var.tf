...
variable "primary_region" {
  description = "AWSwwwww region to launch   еееееее еее primary db instances for global database AWS region to launch primary db instances for global database AWS region to launch primary db instances for global database AWS region to launch primary db instances for global database AWS region to launch primary db instances for global database AWS region to launch primary db instances for global database AWS region to launch primary db instances for global database AWS region to launch primary db instances for global database AWS region to launch primary db instances for global database AWS region to launch primary db instances for global database AWS region to launch primary db instances for global database AWS region to launch primary db instances for global database AWS region to launch primary db instances for global database AWS region to launch primary db instances for global database AWS region to launch primary db instances for global database"
  default     = "us-east-1"
}
